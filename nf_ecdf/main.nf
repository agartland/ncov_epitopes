...
params.output_folder = "s3://fh-pi-gilbert-p/agartlan/ncov_tcrs/mira/2020-SEP-21/"
params.batchfile = "s3://fh-pi-gilbert-p/agartlan/ncov_tcrs/mira/csv_manifest_bkd.csv"
...
Channel.from(file(params.batchfile))
    ...
    .map { sample ->[sample.file, sample.name, file(sample.complete), file(sample.bkgd)] }
...
process mira_ecdf {
    ...
    input: 
        set file, name, file(complete), file(bkgd) from input_channel
